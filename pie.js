...
class Pie {
    constructor(id, option) {
        ...
        if (typeof option.progress == 'object') {
            this.progress = {
                ...
                position: option.progress.position || [this.centerX, this.centerY],
    ...
    drawPiePointer() {
        ...
        const x = Math.cos(rad) * (this.radius - 10) // 计算指示器的x坐标
        const y = Math.sin(rad) * (this.radius - 10) // 计算指示器的y坐标
